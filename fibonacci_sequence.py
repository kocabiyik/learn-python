...
parser = argparse.ArgumentParser(description="Prints Fibonacci numbers up to a limit")
parser.add_argument("--up_to", type=int, default=100, help="The upper limit for the Fibonacci sequence")
